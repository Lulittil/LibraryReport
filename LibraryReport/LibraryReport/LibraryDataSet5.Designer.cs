...
namespace LibraryReport.LibraryDataSet5TableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Books] ([Name], [Author], [Year], [Cost], [Count], [Genre]) VALUES (" +
                "@Name, @Author, @Year, @Cost, @Count, @Genre);\r\nSELECT Id, Name, Author, Year, C" +
                "ost, Count, Genre FROM Books WHERE (Id = SCOPE_IDENTITY())";
...
SELECT Id, Name, Author, Year, Cost, Count, Genre FROM Books WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Name", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Name", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@author", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Author", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        public virtual int FillBy(LibraryDataSet5.BooksDataTable dataTable, string Author) {
        ...
        public virtual LibraryDataSet5.BooksDataTable GetDataBy(string Author) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Author == null)) {
                throw new global::System.ArgumentNullException("Author");
            }
        ...
        public virtual int Insert(string Name, string Author, int Year, double Cost, int Count, string Genre) {
            if ((Name == null)) {
        ...
        public virtual int UpdateQuery(int Count, string Name, string author) {
